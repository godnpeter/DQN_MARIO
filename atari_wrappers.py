...
# Wrapper that makes openAI gym's observation from HWC to Pytorch format of CWH
...
def wrap_deepmind(env, episode_life=True, preprocess=True, max_and_skip=True,
                  clip_rewards=True, no_op_reset=False, history_length=4, scale=True, pytorch = True):
